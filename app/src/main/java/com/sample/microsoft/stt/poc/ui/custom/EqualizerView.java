...
public class EqualizerView extends LinearLayout {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PodcastsEqualizerView, 0, 0);
        try {
            mRunInBatterySafeMode = a.getBoolean(R.styleable.PodcastsEqualizerView_runInBatterySaveMode, DEFAULT_RUN_IN_BATTERY_SAVE_MODE);
            mForegroundColor = a.getInt(R.styleable.PodcastsEqualizerView_barColor, DEFAULT_COLOR);
            mAnimationDuration = a.getInt(R.styleable.PodcastsEqualizerView_animationDuration, DEFAULT_DURATION);
            mBarCount = a.getInt(R.styleable.PodcastsEqualizerView_barCount, DEFAULT_BAR_COUNT);
            mBarWidth = (int) a.getDimension(R.styleable.PodcastsEqualizerView_barWidth, DEFAULT_WIDTH);
            mMarginLeft = (int) a.getDimension(R.styleable.PodcastsEqualizerView_marginLeft, DEFAULT_MARGIN_LEFT);
            mMarginRight = (int) a.getDimension(R.styleable.PodcastsEqualizerView_marginRight, DEFAULT_MARGIN_RIGHT);
