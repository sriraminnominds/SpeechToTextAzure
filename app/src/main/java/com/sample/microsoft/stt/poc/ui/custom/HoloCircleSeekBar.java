...
public class HoloCircleSeekBar extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        minsTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.LINEAR_TEXT_FLAG);
        minsTextPaint.setColor(text_color);
        minsTextPaint.setStyle(Style.FILL_AND_STROKE);
        minsTextPaint.setTextAlign(Align.LEFT);
        // canvas.drawPaint(textPaint);
        minsTextPaint.setTextSize(text_size / 2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (show_text)
            ...
            canvas.drawText(
                    "mins",
                    (mColorWheelRectangle.centerX()) - (minsTextPaint.measureText("mins") / 2),
